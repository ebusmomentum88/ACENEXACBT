...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles =
    "font-bold rounded-2xl transition-all duration-200 transform hover:-translate-y-1 active:translate-y-0 disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_4px_0_0_rgba(0,0,0,0.2)] active:shadow-none";
